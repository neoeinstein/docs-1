...
{{site.data.alerts.callout_info}}You can also add the Check constraint to existing tables through [`ADD CONSTRAINT`](add-constraint.html#add-the-check-constraint).{{site.data.alerts.end}}
